...
const test1: CheckInputsType = { name : 'kim', phone : 123, email : 'abc@naver.com' }
const test2 : CheckInputsType = {name :"박병관", phone:811919, email : "pbk575@gmail.com", age:false }
...
// part2 1강 숙제2
function 함수1강2({user,comment, admin} : 
